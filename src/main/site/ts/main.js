...
function postAndUpdate() {
    ...
    fetch('http://localhost:4567/butt', {
        // Request method
        method: 'post',
...
function updateSuggestions(matches) {
    ...
    matches.forEach(function (match) { return listSuggestions.innerHTML += "<li tabindex=\"0\">" + match + "</li>"; });
}
...
document.addEventListener("keyup", function (event) {
    if (event.key === "a") {
        updateValues("Aries", "Aries", "Aries").then(postAndUpdate);
    }
});
